...
if Admin.all.empty?
  ...
  tests = Test.create([{ title: 'title 1', level: 1, category_id: rand(1..Category.count), author: admin },
                       { title: 'title 2', level: 2, category_id: rand(1..Category.count), author: admin },
                       { title: 'title 3', level: 3, category_id: rand(1..Category.count), author: admin }])
